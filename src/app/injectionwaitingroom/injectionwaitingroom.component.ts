...
// import {WorkbenchService} from "../../doctor/services/workbench.service"
...
// @Component({
//   selector: 'app-pharmawaitingroom',
//   templateUrl: './pharmawaitingroom.component.html',
//   styleUrls: ['./pharmawaitingroom.component.css']
// })
// export class PharmawaitingroomComponent implements OnInit {
...
//     .flatMap(persons => {
//       return (Observable.forkJoin(persons.map(person => {
//         return Observable.forkJoin([Observable.of({id:person.id,w_id:person.w_id,p_id:person.patient_id,g_id:person.guest}),this.notificationService.getPrescriptionDetials(person.history)])
//         .map(data=>{
//           if(data[1].length>=1){
//           let result = 
//           {
...
//       this.notificationService.popFromQueue(this.CurrentPatient.id)
...
//       // submit the record and updar=te inn billing table
